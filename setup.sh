...
#Welcome Note
echo -e "============================================="
echo -e " ${green} WELCOME TO JINGGO SCRIPT LIFETIME VERSION ${NC}"
echo -e "============================================="
sleep 2
...
echo -e "============================================="
sleep 2
wget https://raw.githubusercontent.com/jinGGo007/LIFETIME/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
sleep 2
clear
...
echo " "
echo "========================= JINGGO AUTOSCRIPT VERSION 1 ====================" | tee -a log-install.txt
